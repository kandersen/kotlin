...
public class BytecodeTextTestGenerated extends AbstractBytecodeTextTest {
    ...
    @TestMetadata("compiler/testData/codegen/bytecodeText/ieee754LanguageVersion10")
    @TestDataPath("$PROJECT_ROOT")
    @RunWith(JUnit3RunnerWithInners.class)
    public static class Ieee754LanguageVersion10 extends AbstractBytecodeTextTest {
        private void runTest(String testDataFilePath) throws Exception {
            KotlinTestUtils.runTest(this::doTest, TargetBackend.JVM, testDataFilePath);
        }

        public void testAllFilesPresentInIeee754LanguageVersion10() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("compiler/testData/codegen/bytecodeText/ieee754LanguageVersion10"), Pattern.compile("^(.+)\\.kt$"), TargetBackend.JVM, true);
        }

        @TestMetadata("nullableDoubleEquals10.kt")
        public void testNullableDoubleEquals10() throws Exception {
            runTest("compiler/testData/codegen/bytecodeText/ieee754LanguageVersion10/nullableDoubleEquals10.kt");
        }

        @TestMetadata("nullableDoubleNotEquals10.kt")
        public void testNullableDoubleNotEquals10() throws Exception {
            runTest("compiler/testData/codegen/bytecodeText/ieee754LanguageVersion10/nullableDoubleNotEquals10.kt");
        }

        @TestMetadata("nullableFloatEquals10.kt")
        public void testNullableFloatEquals10() throws Exception {
            runTest("compiler/testData/codegen/bytecodeText/ieee754LanguageVersion10/nullableFloatEquals10.kt");
        }

        @TestMetadata("nullableFloatNotEquals10.kt")
        public void testNullableFloatNotEquals10() throws Exception {
            runTest("compiler/testData/codegen/bytecodeText/ieee754LanguageVersion10/nullableFloatNotEquals10.kt");
        }

        @TestMetadata("smartCastsForDouble10.kt")
        public void testSmartCastsForDouble10() throws Exception {
            runTest("compiler/testData/codegen/bytecodeText/ieee754LanguageVersion10/smartCastsForDouble10.kt");
        }

        @TestMetadata("smartCastsForFloat10.kt")
        public void testSmartCastsForFloat10() throws Exception {
            runTest("compiler/testData/codegen/bytecodeText/ieee754LanguageVersion10/smartCastsForFloat10.kt");
        }

        @TestMetadata("when10.kt")
        public void testWhen10() throws Exception {
            runTest("compiler/testData/codegen/bytecodeText/ieee754LanguageVersion10/when10.kt");
        }

        @TestMetadata("whenNullableSmartCast10.kt")
        public void testWhenNullableSmartCast10() throws Exception {
            runTest("compiler/testData/codegen/bytecodeText/ieee754LanguageVersion10/whenNullableSmartCast10.kt");
        }
    }
