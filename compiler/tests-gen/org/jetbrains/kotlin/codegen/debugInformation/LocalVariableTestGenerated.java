...
public class LocalVariableTestGenerated extends AbstractLocalVariableTest {
    ...
    public static class Suspend extends AbstractLocalVariableTest {
        ...
        @TestDataPath("$PROJECT_ROOT")
        @RunWith(BlockJUnit4ClassRunner.class)
        public static class Parameters extends AbstractLocalVariableTest {
            private void runTest(String testDataFilePath) throws Exception {
                KotlinTestUtils.runTest(this::doTest, TargetBackend.JVM, testDataFilePath);
            }
            ...
            public void testAllFilesPresentInParameters() throws Exception {
                KtTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("compiler/testData/debug/localVariables/suspend/parameters"), Pattern.compile("^(.+)\\.kt$"), null, TargetBackend.JVM, true);
            }
